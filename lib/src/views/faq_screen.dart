        ...
        child: Center(
          child: Column(
            children: [
              ...
              Semantics(
                label: 'Answer to who this app is for',
                child: Container(
              ...
              Semantics(
                label: 'Answer to how to get started',
                child: Container(
                  width: MediaQuery.of(context).size.width * 0.9,
                  child: FAQ(
              ...
              Semantics(
                label: 'Answer to how this app works',
                child: Container(
                  width: MediaQuery.of(context).size.width * 0.9,
                  child: FAQ(
              ...
              Semantics(
                label: 'Answer to how to fix camera function',
                child: Container(
                  width: MediaQuery.of(context).size.width * 0.9,
                  child: FAQ(
              ...
              Semantics(
                label: 'Answer to how to fix location tracking',
                child: Container(
                  width: MediaQuery.of(context).size.width * 0.9,
                  child: FAQ(
              ...
              Semantics(
                label: 'Answer to how to fix history',
                child: Container(
                  width: MediaQuery.of(context).size.width * 0.9,
                  child: FAQ(
                    question: "History not updating?",
                    answer:
                        "If this is the case, you may need to manually press the refresh button in the lower right corner. There are a lot of background processes going on, so give it a little bit of time!",
                    showDivider: false,
                    expandedIcon: const Icon(Icons.arrow_drop_up_rounded,
                        size: 40.0, color: Colors.green),
                    collapsedIcon:
              ...
              Semantics(
                label:
                    'What to do when you trust a prototype to be fully built out',
                child: Container(
                  width: MediaQuery.of(context).size.width * 0.9,
                  child: FAQ(
